...
import com.devanshigupta.newtry.AppController;

public class PlaceListOnMapActivity extends AppCompatActivity implements OnMapReadyCallback,GoogleMap.OnMarkerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationTag=SearchManager.QUERY;
        mLocationName=SearchManager.QUERY;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setSearchableInfo(searchManager.getSearchableInfo(new ComponentName(this, String.valueOf(this))));
