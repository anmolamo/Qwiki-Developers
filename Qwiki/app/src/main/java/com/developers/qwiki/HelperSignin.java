...
public class HelperSignin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_helper_signin);

        e1 = (EditText) findViewById(R.id.emailHelper);
        e2= (EditText) findViewById(R.id.passwordHelper);

        tv1= (TextView) findViewById(R.id.textView2);

        auth=FirebaseAuth.getInstance();

        b1= (Button) findViewById(R.id.loginHelper);
...
//                startActivity(i);
        ...
        signInButton=(SignInButton)findViewById(R.id.sign_in_button_helper);
